...
<div class="back-img back-img1">
   ...
   <?php
      ...
      if ( isset( $_POST[ 'sub' ] ) ) 
      	...
      	$up = "update exhibition_events set 	event_name='$a', 	event_about='$b', 	event_category='$c', event_venue='$d', event_date='$e',event_time='$f', event_photo='$target_path' where ex_id='$r'"; // this query for updating Exhibition & Events Details1
