              ...
              while($result=mysqli_fetch_array($run))
            {
              ...
              <div class='col-md-3 col-sm-6 alllist productlist'>
                  <div style='border: 2px solid #000;margin: 20px;text-align: -webkit-center;'>
                       <div><img src='$result[7]' style='height:230px width:300px;' class='img-responsive'></div>
                      <div style='background:green;color:#fff;font-size:16px;font-weight:bold;' class='text-center text-capitalize'><span>
                  $result[1] <br/>  <span>
              About : $result[2]</span> <br/> Category : $result[3]</span></div><div class='product-des' style='background:#000;color:#fff;font-size: 16px;height:80px;overflow-y:hidden;' class='text-center'><span>
            Venue:  $result[4] <br/> Date $result[5] | Time $result[6]</span></div><div class='text-center'style='background:green;font-size: 10px;'>
              </div></div></div>";
